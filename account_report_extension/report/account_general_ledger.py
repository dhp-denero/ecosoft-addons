...
class general_ledger_ext(general_ledger):
    def set_context(self, objects, data, ids, report_type=None):
        ...
        return res
report_sxw.report_sxw('report.account.general.ledger_ext', 'account.account', 'addons/account/report/account_general_ledger.rml', parser=general_ledger_ext, header='internal')
report_sxw.report_sxw('report.account.general.ledger_landscape_ext', 'account.account', 'addons/account/report/account_general_ledger_landscape.rml', parser=general_ledger_ext, header='internal landscape')
