...
#        test = self._get_lines_accounts_inflow(form,account_type=['receivable'])
#        return res
#
...
#                totals.setdefault(str(i), 0.0)
#                totals[str(i)] += float(r[str(i)] or 0.0)
#        print "\n\nRESSSSSSSSSSSSSSs NO PArtner",res
#        return res
#
...
# ====================================================Cash projection Start logic=========================================================================
    def _get_lines_accounts_inflow(self, form, account_type=None): # new method of cash projection
...
#         res = []
        ...
        self.cr.execute('SELECT DISTINCT account_account.id AS id,\
                ...
                WHERE (l.account_id=account_account.id) \
                    ...
                    AND (l.date <= %s)\
                    AND ' + self.query + ' \
                ORDER BY account_account.name', (tuple(move_state), tuple(self.ACCOUNT_TYPE), self.date_from, self.date_from,))
