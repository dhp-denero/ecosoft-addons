...
class sale_order_line_make_invoice(osv.osv_memory):
    ...
    # kittiu
    # THIS IS A COMPLETE OVERWRITE METHOD of sale.wizard.sale_line_invoice.sale_order_line_make_invoice.make_invoices()
    # Just to add a context in calling method sales_order_line_obj.invoice_line_create
    ...
    #TODO: merge with sale.py/make_invoice
        def make_invoice(order, lines):
            ...
            inv = {
                ...
                'add_disc': order.add_disc or False,
                # end kittiu
                'origin': order.name,
                'type': 'out_invoice',
